...
export default function UtilityInput() {
  // Simple state to simulate file drop interaction
            ...
            <div className="relative h-full bg-[#0A0F0D] border border-white/10 rounded-[2.5rem] p-8 overflow-hidden hover:border-amber-500/30 transition-colors duration-500">
              ...
              >
                ...
                <div className="z-10 text-center space-y-3">
                  ...
                  <p className="font-medium text-white/80">
                    {elecFile ? 'Bill_Oct_2025.pdf' : 'Drop PDF or Click to Browse'}
                  </p>
                  {!elecFile && <span className="text-xs text-white/30">Supports PDF, JPG, PNG</span>}
                </div>
              </div>
              ...
              <div className="mt-8 grid grid-cols-2 gap-4">
                <div className="space-y-2">
                  <label className="text-xs font-bold text-white/40 uppercase tracking-wider ml-1">Total Amount</label>
                  <div className="relative">
                    <span className="absolute left-4 top-1/2 -translate-y-1/2 text-white/30 font-serif">₹</span>
                    <input type="text" defaultValue="4,500" className="w-full bg-white/5 border border-white/10 rounded-xl py-3 pl-8 pr-4 text-white font-mono focus:outline-none focus:border-amber-500/50 focus:bg-amber-500/5 transition-all" />
                  </div>
                </div>
                <div className="space-y-2">
                  <label className="text-xs font-bold text-white/40 uppercase tracking-wider ml-1">Units (kWh)</label>
                  <div className="relative">
                    <Zap className="absolute left-4 top-1/2 -translate-y-1/2 w-4 h-4 text-white/30" />
                    <input type="text" defaultValue="800" className="w-full bg-white/5 border border-white/10 rounded-xl py-3 pl-10 pr-4 text-white font-mono focus:outline-none focus:border-amber-500/50 focus:bg-amber-500/5 transition-all" />
                  </div>
                </div>
              </div>
            </div>
            ...
            <div className="relative h-full bg-[#0A0F0D] border border-white/10 rounded-[2.5rem] p-8 overflow-hidden hover:border-cyan-500/30 transition-colors duration-500">
              ...
              <div className="flex items-center justify-between mb-8">
                <div className="flex items-center gap-4">
                  ...
                  <div>
                    <h2 className="text-2xl font-bold font-display">Water Supply</h2>
              ...
              {/* Upload Zone */}
              <div className="relative h-48 rounded-2xl border-2 border-dashed border-white/10 bg-white/[0.02] hover:bg-white/[0.04] hover:border-cyan-500/50 transition-all duration-300 flex flex-col items-center justify-center cursor-pointer overflow-hidden group/upload">
                ...
                <div className="z-10 text-center space-y-3">
                  <div className="mx-auto w-12 h-12 rounded-full bg-white/5 flex items-center justify-center text-white/40 group-hover/upload:scale-110 transition-transform">
                    <UploadCloud className="w-6 h-6" />
                  </div>
                  <p className="font-medium text-white/80">Drop PDF or Click to Browse</p>
                  <span className="text-xs text-white/30">Supports PDF, JPG, PNG</span>
                </div>
              </div>
              ...
              <div className="mt-8 grid grid-cols-2 gap-4">
                <div className="space-y-2">
                  ...
                  <div className="relative">
                    <span className="absolute left-4 top-1/2 -translate-y-1/2 text-white/30 font-serif">₹</span>
                    <input type="text" defaultValue="1,200" className="w-full bg-white/5 border border-white/10 rounded-xl py-3 pl-8 pr-4 text-white font-mono focus:outline-none focus:border-cyan-500/50 focus:bg-cyan-500/5 transition-all" />
                  </div>
                </div>
                <div className="space-y-2">
                  <label className="text-xs font-bold text-white/40 uppercase tracking-wider ml-1">Volume (L)</label>
                  <div className="relative">
                    <Droplets className="absolute left-4 top-1/2 -translate-y-1/2 w-4 h-4 text-white/30" />
                    <input type="text" defaultValue="45k" className="w-full bg-white/5 border border-white/10 rounded-xl py-3 pl-10 pr-4 text-white font-mono focus:outline-none focus:border-cyan-500/50 focus:bg-cyan-500/5 transition-all" />
                  </div>
                </div>
              </div>
            </div>
