  ...
  return (
    <div className={`${outfit.variable} ${inter.variable} min-h-screen bg-[#050B08] flex items-center justify-center p-4 relative overflow-hidden font-sans selection:bg-emerald-500/30 text-white`}>
      ...
      <div className="absolute inset-0 z-0 pointer-events-none">
        {/* Dynamic Blobs based on User Type */}
            ...
            <div className="space-y-4 relative z-10 animate-in fade-in slide-in-from-bottom-4 duration-500">
              ...
              <div className="relative py-2">
                ...
                <div className="relative flex justify-center">
                  <span className="bg-[#0b1210] px-4 text-xs text-white/40 uppercase tracking-widest">Or</span>
                </div>
              </div>
              ...
              <div className="relative group">
                ...
                <input 
                  ...
                  className="w-full pl-12 pr-4 py-4 bg-black/30 rounded-2xl border border-white/10 focus:border-emerald-500/50 focus:ring-4 focus:ring-emerald-500/10 text-white transition-all outline-none placeholder:text-white/20" 
                />
              </div>
            ...
            <div className="space-y-4 relative z-10 animate-in fade-in slide-in-from-right-4 duration-500">
              ...
              <div className="p-3 bg-blue-500/10 border border-blue-500/20 rounded-xl flex gap-3 items-start mb-2">
                ...
                <p className="text-xs text-blue-200/80 leading-relaxed">
                  Access requires Level 4 security clearance. All actions are logged and audited.
                </p>
              </div>
              ...
              <div className="relative group">
                ...
                <input 
                  ...
                  className="w-full pl-12 pr-4 py-4 bg-black/30 backdrop-blur-sm rounded-2xl border border-white/10 focus:border-blue-500/50 focus:ring-4 focus:ring-blue-500/10 text-white placeholder-white/30 transition-all outline-none font-mono" 
                />
              </div>
              ...
              <div className="relative group">
                ...
                <input 
                  ...
                  className="w-full pl-12 pr-4 py-4 bg-black/30 backdrop-blur-sm rounded-2xl border border-white/10 focus:border-blue-500/50 focus:ring-4 focus:ring-blue-500/10 text-white placeholder-white/30 transition-all outline-none" 
                />
              </div>
              ...
              <div className="relative group">
                ...
                <input 
                  ...
                  className="w-full pl-12 pr-4 py-4 bg-black/30 backdrop-blur-sm rounded-2xl border border-white/10 focus:border-blue-500/50 focus:ring-4 focus:ring-blue-500/10 text-white placeholder-white/30 transition-all outline-none font-mono tracking-widest" 
                />
              </div>

              {/* Authenticate Button */}
              <div className="mt-6">
                <Link href="/gov-admin" className="group w-full flex items-center justify-center gap-3 bg-gradient-to-r from-blue-600 to-indigo-600 text-white py-4 px-8 rounded-2xl text-lg font-bold shadow-[0_0_20px_rgba(37,99,235,0.4)] hover:shadow-[0_0_30px_rgba(37,99,235,0.6)] hover:scale-[1.02] active:scale-[0.98] transition-all">
